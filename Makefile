...
build-windows-webview:
	...
	@echo "       go mod tidy"
	@echo "       go build -tags webview -o launchpad-webview.exe"
	@echo ""
...
build-windows-webview-debug:
	...
	@echo "       go build -tags webview -o launchpad-webview-debug.exe"
	@echo ""
...
# Prepare dependencies (download, tidy, and vendor)
prepare-deps:
	@echo "Preparing dependencies (download, tidy, vendor)..."
	@./prepare-deps.sh || echo "Note: Run ./prepare-deps.sh directly for detailed output"

# Prepare dependencies and vendor
vendor: prepare-deps
	@echo "Dependencies prepared and vendored"
...
# Show help
help:
	@echo "KrankyBear LaunchPad - Makefile commands:"
	@echo ""
	...
	@echo "  make prepare-deps   - Download, tidy, and vendor all dependencies"
	@echo "  make vendor         - Alias for prepare-deps"
