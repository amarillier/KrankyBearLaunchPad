...
echo "Inno Setup Inno/KrankyBearLaunchPad.iss"
sed -i '' "s/MyAppVersion \".*\"/MyAppVersion \"$ver\"/" ./Inno/KrankyBearLaunchPad.iss
...
cp LICENSE KrankyBearLaunchPad.app/Contents/Resources
cp ReleaseNotes.txt ./KrankyBearLaunchPad.app/Contents/Resources
