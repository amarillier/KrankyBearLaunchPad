...
# prepare-deps.sh - Prepare Go dependencies for KrankyBear LaunchPad
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}KrankyBear LaunchPad - Dependency Setup${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
echo "  make build"
echo "  or"
echo "  go build -mod=vendor -o launchpad"
echo ""
