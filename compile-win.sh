...
echo "KrankyBear LaunchPad - Windows Sync, Compile. Package and Sync Back (bash)"
echo "================================================"
echo
...
# ./setIcon.sh Resources/Images/KrankyBearRedPlaidTrapper.png bin/launchpad-windows.exe
